...
Config.MapText = "MarocRolePlay.com" -- This is the name / text shown above the map
...
Config.ConsumablesAlcoholPercent = {
    ["whiskey"] = 10,
    ["beer"] = 1,
    ["vodka"] = 10,
}
